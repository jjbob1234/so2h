...
// #region SO2H [Menu] so2h 6-page hexagon prism owl-warp tables - mechanically
// generated by tools/gen_pause_geometry.py (STRICTRULES.md rule 20). Never hand-edit;
// regenerate and re-paste instead.
s16 sKaleidoSetupRightPageIndex[] = {
    PAUSE_ITEM_OOT,  // PAUSE_ITEM
    PAUSE_MAP,       // PAUSE_ITEM_OOT
    PAUSE_QUEST,     // PAUSE_MAP
    PAUSE_MASK,      // PAUSE_QUEST
    PAUSE_EQUIP_OOT, // PAUSE_MASK
    PAUSE_ITEM,      // PAUSE_EQUIP_OOT
};

f32 sKaleidoSetupRightPageEyeX[] = {
    PAUSE_EYE_DIST * -PAUSE_ITEM_OOT_X,  // PAUSE_ITEM
    PAUSE_EYE_DIST * -PAUSE_MAP_X,       // PAUSE_ITEM_OOT
    PAUSE_EYE_DIST * -PAUSE_QUEST_X,     // PAUSE_MAP
    PAUSE_EYE_DIST * -PAUSE_MASK_X,      // PAUSE_QUEST
    PAUSE_EYE_DIST * -PAUSE_EQUIP_OOT_X, // PAUSE_MASK
    PAUSE_EYE_DIST * -PAUSE_ITEM_X,      // PAUSE_EQUIP_OOT
};

f32 sKaleidoSetupRightPageEyeZ[] = {
    PAUSE_EYE_DIST * -PAUSE_ITEM_OOT_Z,  // PAUSE_ITEM
    PAUSE_EYE_DIST * -PAUSE_MAP_Z,       // PAUSE_ITEM_OOT
    PAUSE_EYE_DIST * -PAUSE_QUEST_Z,     // PAUSE_MAP
    PAUSE_EYE_DIST * -PAUSE_MASK_Z,      // PAUSE_QUEST
    PAUSE_EYE_DIST * -PAUSE_EQUIP_OOT_Z, // PAUSE_MASK
    PAUSE_EYE_DIST * -PAUSE_ITEM_Z,      // PAUSE_EQUIP_OOT
};
// #endregion
